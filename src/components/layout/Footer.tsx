            ...
            <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-2 text-[10px] sm:text-xs text-muted-foreground">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <span>•</span>
                        <a
                            href="https://discord.gg/2kUtVBScD4"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-[#5865F2] text-white hover:bg-[#4752C4] transition-colors text-[10px] sm:text-xs font-medium"
                        >
                            <svg
